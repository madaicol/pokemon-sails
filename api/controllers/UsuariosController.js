...
console.log(req);
        ...
        sails.log.info('Perfil: ', req.session.user.id);
        ...
        req.file('perfil').upload({
            ...
            Usuarios.update(req.session.user.id, {

                    // Generate a unique URL where the avatar can be downloaded.
                    avatarUrl: require('util').format('%s/user/avatar/%s', sails.getBaseUrl(), req.session.user.id),
				...
				console.log(req.session.user.url);
